// lib/features/loadout/data/repositories/loadout_http_repository_impl.dart
...
class LoadoutHttpRepositoryImpl implements LoadoutRepository {
  final LoadoutHttpDataSource httpDataSource;

  LoadoutHttpRepositoryImpl({required this.httpDataSource});
